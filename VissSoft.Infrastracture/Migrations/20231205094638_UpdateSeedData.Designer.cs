...
namespace VissSoft.Infrastracture.Migrations
{
    ...
    [Migration("20231205094638_UpdateSeedData")]
            ...
            modelBuilder.Entity("VissSoft.Core.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = 1,
                            color = "#ffb74a",
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1415),
                        ...
                        new
                        {
                            id = 2,
                            color = "#00bc51",
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1440),
                        ...
                        new
                        {
                            id = 3,
                            color = "#ff9679",
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1441),
                            imgLink = "Images/Course/course-1.png",
                        ...
                        new
                        {
                            id = 4,
                            color = "#1dc2da",
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1442),
                            imgLink = "Images/Course/course-2.png",
            ...
            modelBuilder.Entity("VissSoft.Core.Entities.Intro", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1560),
                            status = true,
            ...
            modelBuilder.Entity("VissSoft.Core.Entities.NewAndEvent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1576),
                        ...
                        new
                        {
                            id = 2,
                            content = "Mọi thông tin về vòng thi sắp tới đây đều được cập nhật và thông báo tại đây",
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1578),
                        ...
                        new
                        {
                            id = 3,
                            content = "Mọi thông tin về vòng thi sắp tới đây đều được cập nhật và thông báo tại đây",
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1579),
                        ...
                        new
                        {
                            id = 4,
                            content = "Mọi thông tin về vòng thi sắp tới đây đều được cập nhật và thông báo tại đây",
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1611),
            ...
            modelBuilder.Entity("VissSoft.Core.Entities.Slide", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1626),
                        ...
                        {
                            id = 2,
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1628),
                        ...
                        {
                            id = 3,
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1629),
            ...
            modelBuilder.Entity("VissSoft.Core.Entities.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1642),
                        ...
                        new
                        {
                            ...
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1644),
                            description = "Với kinh nghiệm nhiều năm trong nghề, thầy đã không chỉ giup các em học sinh trở nên yêu thích môn Toán, mà còn đạt giải cao trong các cuộc thi lớn...",
                        ...
                        new
                        {
                            ...
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1645),
                            description = "Với kinh nghiệm nhiều năm trong nghề, thầy đã không chỉ giup các em học sinh trở nên yêu thích môn Toán, mà còn đạt giải cao trong các cuộc thi lớn...",
                        ...
                        new
                        {
                            ...
                            created_at = new DateTime(2023, 12, 5, 16, 46, 38, 64, DateTimeKind.Local).AddTicks(1646),
                            description = "Với kinh nghiệm nhiều năm trong nghề, thầy đã không chỉ giup các em học sinh trở nên yêu thích môn Toán, mà còn đạt giải cao trong các cuộc thi lớn...",
