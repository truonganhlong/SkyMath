...
namespace VissSoft.WebApi.Controllers
{
    ...
    {
        private readonly SlideRepository _repository;
        public SlideController(VissSoftDbContext dbContext, IMapper mapper) {
            _repository = new SlideRepository(dbContext,mapper);
        }
