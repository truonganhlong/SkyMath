...
namespace VissSoft.WebApi.Controllers
{
    ...
    [ApiController]
    public class NewAndEventController : BaseController
    {
        private readonly NewAndEventRepository _repository;
        public NewAndEventController(VissSoftDbContext dbContext, IMapper mapper)
        {
            _repository = new NewAndEventRepository(dbContext, mapper);
        }
